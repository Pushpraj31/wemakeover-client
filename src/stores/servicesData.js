...
export const servicesData = {
  waxing: {
    title: "Waxing",
    description: "Smooth and glowing skin with safe, hygienic waxing services at home.",
    currency: "₹",
    items: [
      {
        id: "waxing-hand-leg-classic",
      ...
      {
        id: "waxing-hand-leg-premium",
        name: "Hand & Leg (Premium)",
      ...
      {
        id: "waxing-bikini-premium",
        name: "Bikini Waxing (Premium)",
